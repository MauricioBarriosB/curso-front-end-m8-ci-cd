...
import { DbLocal, ISpecialties } from "../services/DbLocal";
...
const Home = () => {
    ...
    const fetchSpecialtiesOnline = async () => {
    ...
    const fetchSpecialtiesLocal = async () => {
        const data = await DbLocal.specialties.toArray();
        setSpecialties(data);
    };
