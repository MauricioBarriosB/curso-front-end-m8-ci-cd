...
import { DbLocal, IAppointments } from "../services/DbLocal";
...
function Appointments() {
    ...
    const fetchAppointments = async () => {
        ...
        if (!data.error) {
            ...
            await DbLocal.appointments.bulkPut(data);
    ...
    const fetchAppointmentsLocal = async () => {
        const data = await DbLocal.appointments.toArray();
        setAppointments(data);
    };
