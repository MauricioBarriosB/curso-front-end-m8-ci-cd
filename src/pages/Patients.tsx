...
import { DbLocal, IPatients } from "../services/DbLocal";
...
const Patients = () => {
    ...
    const fetchPatientsLocal = async () => {
        const data = await DbLocal.patients.toArray();
        setPatients(data);
        patientsRef.current = data;
    };
